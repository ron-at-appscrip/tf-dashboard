...
export const funnelColumns: ColumnDef<Funnel>[] = [
  {
    accessorKey: "name",
    header: ({ column }) => {
      return (
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>Duplicate funnel</DropdownMenuItem>
            <DropdownMenuItem>View analytics</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-destructive">Delete funnel</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
    },
